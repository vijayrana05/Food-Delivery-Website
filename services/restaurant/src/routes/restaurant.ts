...
import { addRestaurant, fetchMyRestaurant, fetchSingleRestaurant, getNearbyRestaurants, updateRestaurant, updateStatusRestaurant } from '../controllers/restaurant.js'
...
router.get("/id/:id", isAuth, fetchSingleRestaurant)
